 ...
 */
export default {
  addVariable: 'Add Create Table Variable',
  modifyVariable: 'Modify Create Table Variable',
  deleteVariable: 'Delete Create Table Variable',
  deletePopConfirm: 'Are you sure delete this create table variable ?',
  add: 'Add',
  success: ' successful',
  fail: ' failed',
  table: {
    title: 'Create table variable List',
  ...
  form: {
    ...
    exists: 'Sorry, the Create Table Variable Code already exists',
  ...
  depend: {
    title: 'Create Table Variable Depend Apps',
    jobName: 'Application Name',
    nickName: 'Owner',
    headerTitle: 'Create Table Variable " {0} " used list',
  },
};
